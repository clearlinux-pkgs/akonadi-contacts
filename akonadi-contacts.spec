...
Source0  : https://download.kde.org/stable/release-service/22.12.2/src/akonadi-contacts-22.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.2/src/akonadi-contacts-22.12.2.tar.xz.sig
...
%prep
%setup -q -n akonadi-contacts-22.12.2
cd %{_builddir}/akonadi-contacts-22.12.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676827052
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5AkonadiContact.so.5.22.2
/usr/lib64/libKF5ContactEditor.so.5
/usr/lib64/libKF5ContactEditor.so.5.22.2
