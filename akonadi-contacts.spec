...
Version  : 22.12.3
Release  : 52
URL      : https://download.kde.org/stable/release-service/22.12.3/src/akonadi-contacts-22.12.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.12.3/src/akonadi-contacts-22.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.3/src/akonadi-contacts-22.12.3.tar.xz.sig
...
%prep
%setup -q -n akonadi-contacts-22.12.3
cd %{_builddir}/akonadi-contacts-22.12.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677797503
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5AkonadiContact.so.5.22.3
/usr/lib64/libKF5ContactEditor.so.5
/usr/lib64/libKF5ContactEditor.so.5.22.3
