...
Source0  : https://download.kde.org/stable/release-service/22.08.0/src/akonadi-contacts-22.08.0.tar.xz
...
%prep
%setup -q -n akonadi-contacts-22.08.0
cd %{_builddir}/akonadi-contacts-22.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661554122
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5AkonadiContact.so.5.21.0
/usr/lib64/libKF5ContactEditor.so.5
/usr/lib64/libKF5ContactEditor.so.5.21.0
