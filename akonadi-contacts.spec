...
Source0  : https://download.kde.org/stable/release-service/24.02.2/src/akonadi-contacts-24.02.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.2/src/akonadi-contacts-24.02.2.tar.xz.sig
...
%setup -q -n akonadi-contacts-24.02.2
cd %{_builddir}/akonadi-contacts-24.02.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713218544
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim6AkonadiContactCore.so.6.0.2
/V3/usr/lib64/libKPim6AkonadiContactWidgets.so.6.0.2
...
/usr/lib64/libKPim6AkonadiContactCore.so.6.0.2
/usr/lib64/libKPim6AkonadiContactWidgets.so.6
/usr/lib64/libKPim6AkonadiContactWidgets.so.6.0.2
