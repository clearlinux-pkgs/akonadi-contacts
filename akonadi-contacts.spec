...
Source0  : https://download.kde.org/stable/release-service/25.04.2/src/akonadi-contacts-25.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.2/src/akonadi-contacts-25.04.2.tar.xz.sig
...
%setup -q -n akonadi-contacts-25.04.2
cd %{_builddir}/akonadi-contacts-25.04.2
pushd ..
cp -a akonadi-contacts-25.04.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749523521
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim6AkonadiContactCore.so.6.4.2
/V3/usr/lib64/libKPim6AkonadiContactWidgets.so.6.4.2
...
/usr/lib64/libKPim6AkonadiContactCore.so.6.4.2
/usr/lib64/libKPim6AkonadiContactWidgets.so.6
/usr/lib64/libKPim6AkonadiContactWidgets.so.6.4.2
